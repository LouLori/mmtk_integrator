...
#                    rcm_New[a][m]+=R[m][n]*rcm_stand[a][n]
...
#print 'eulan1= ', eulan1, 'eulan2= ', eulan2
#print 'eulrel= ', eulrel
...
##############################
    ...
    cdef start(self):
        ...
        cdef int P
        cdef N.ndarray[double, ndim=1] theta, phi, chi
	...
	# MATT-Introduce X-COM variable, number of molecules Nmol
        ...
        # Count the number of molecules which is not monoatomic molecule
        Ntruemol=0
        for i in range(Nmol):
...
#        print 'rcm_L= ', rcm_L, 'rcm_C= ', rcm_C, 'rcm_R= ', rcm_R
#        print 'MCAngles= ', MCAngles
        ...
        for step in range(nsteps):
            ...
            for t1b in range(P):
                ...
                for a in range(Nmol):
                    ...
                    # Check if there is monoatomic molecule, like He
                    if (natomspmol==1):
