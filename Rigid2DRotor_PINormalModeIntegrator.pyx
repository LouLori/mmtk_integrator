...
#
cdef class Rigid2DRotor_PINormalModeIntegrator(MMTK.PIIntegratorSupport.PIIntegrator):
        ...
        for k in range(Nmol):
            ...
            if (natomspmol>1):
                for i in range(nbeadspmol):
                    ...
                    unirel=rel/N.linalg.norm(rel)
                    costheta[k*nbeadspmol+i]=unirel[2]
                    phi[k*nbeadspmol+i]= N.arctan2(unirel[1],unirel[0])
...
#
cdef class Rigid2DRotor_PILangevinNormalModeIntegrator(Rigid2DRotor_PINormalModeIntegrator):
    ...
    cdef start(self):
        ...
        Rigid2DRotor_PINormalModeIntegrator.start(self)
