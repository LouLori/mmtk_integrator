...
compile_args = []
prefix_user='/home/x3lou/.mmtk/'
include_dirs= [prefix_user+'include/python2.7/', prefix_user+'src/path_integrals/Include', prefix_user+'include', 'Include']
libraries = []
macros = []
...
library_dirs = ['/home/x3lou/.mmtk/lib']
...
ext_modules=[
    Extension('Rigid2DRotor_PINormalModeIntegrator',
              ['./Rigid2DRotor_PINormalModeIntegrator.pyx'],
              extra_compile_args = compile_args,
              include_dirs=include_dirs,
              library_dirs=library_dirs,
              libraries=libraries+ ['fftw3'],
              define_macros=macros),
    Extension('Rot2DOnly_PINormalModeIntegrator',
              ['./Rot2DOnly_PINormalModeIntegrator.pyx'],
              extra_compile_args = compile_args,
              include_dirs=include_dirs,
              library_dirs=library_dirs,
              libraries=libraries+ ['fftw3'],
              define_macros=macros),
    Extension('Rot3DOnly_PINormalModeIntegrator',
              ['./Rot3DOnly_PINormalModeIntegrator.pyx'],
              extra_compile_args = compile_args,
              include_dirs=include_dirs,
              library_dirs=library_dirs,
              libraries=libraries+ ['fftw3'],
              define_macros=macros),
    Extension('RotOnly_GCAIntegrator',
              ['./RotOnly_GCAIntegrator.pyx'],
              extra_compile_args = compile_args,
              include_dirs=include_dirs,
              library_dirs=library_dirs,
              libraries=libraries+ ['fftw3'],
              define_macros=macros),
    Extension('Rigid3DRotor_PINormalModeIntegrator',
              ['./Rigid3DRotor_PINormalModeIntegrator.pyx'],
              extra_compile_args = compile_args,
              include_dirs=include_dirs,
              library_dirs=library_dirs,
              libraries=libraries+ ['fftw3'],
